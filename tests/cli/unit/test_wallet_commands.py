...
class TestWalletValidation:
    ...
    def test_empty_wallet_name(self):
        ...
        result = self.runner.invoke(
            cli, ["wallet", "create-coldkey", "--name", ""], input="password\npassword\ny\n"
        )
...
class TestWalletHotkeyOperations:
    ...
    def test_import_hotkey_requires_file(self):
        ...
        result = self.runner.invoke(
            cli, ["wallet", "import-hotkey", "--coldkey", "test", "--hotkey-name", "test_hk"]
        )
    ...
    def test_regen_hotkey_requires_index(self):
        ...
        result = self.runner.invoke(
            cli, ["wallet", "regen-hotkey", "--coldkey", "test", "--hotkey-name", "test_hk"]
        )
    ...
    def test_register_hotkey_requires_subnet(self):
        ...
        result = self.runner.invoke(
            cli, ["wallet", "register-hotkey", "--coldkey", "test", "--hotkey", "test_hk"]
        )
